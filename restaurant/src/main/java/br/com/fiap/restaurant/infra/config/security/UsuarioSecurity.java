    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/restaurant/create").hasRole("OWNER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/restaurant/update").hasRole("OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/restaurant/delete/{nomeRestaurante}").hasRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/restaurant/search/{nomeRestaurante}").hasRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/restaurant/list/number/{number}/page/{page}").hasRole("OWNER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/cardapio/create").hasRole("OWNER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/cardapio/update").hasRole("OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/cardapio/delete/{product}").hasRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/cardapio/list/number/{number}/page/{page}").hasRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/cardapio/search/{product}").hasRole("OWNER")
                        .anyRequest()
                        .authenticated()
                )
