    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/restaurant/create").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/restaurant/update").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/restaurant/delete/{nomeRestaurante}").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/restaurant/search/{nomeRestaurante}").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/restaurant/list/number/{number}/page/{page}").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.POST, "/api/v1/cardapio/create").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/cardapio/update").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/cardapio/delete/{product}").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/cardapio/list/number/{number}/page/{page}").hasAnyRole("OWNER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/cardapio/search/{product}").hasAnyRole("OWNER")
                        .anyRequest()
                        .authenticated()
                )
